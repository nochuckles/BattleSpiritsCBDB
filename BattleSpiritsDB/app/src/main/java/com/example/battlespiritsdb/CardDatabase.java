...
public abstract class CardDatabase extends RoomDatabase {
    ...
    private static class PopulatedDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            cardDao.insert(new Card(R.drawable.img210,"BS28-079", "Shut out", "Collaboration Booster (Our Digimon Adventure!", 0, "COMMON"));
            cardDao.insert(new Card(R.drawable.img211,"BS33-CP03", "Double Blaster", "Collaboration Booster (Our Digimon Adventure!", 0, "COMMON"));
            cardDao.insert(new Card(R.drawable.img212,"SD02-017", "Strong Draw", "Collaboration Booster (Our Digimon Adventure!", 0, "COMMON"));
