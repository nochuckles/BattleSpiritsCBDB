...
public abstract class CardDatabase extends RoomDatabase {
    ...
    private static class PopulatedDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            cardDao.insert(new Card(R.drawable.img198,"CB05-X01", "Blackwargreymon AA", "Collaboration Booster (Our Digimon Adventure!", 0, "SECRET"));
            cardDao.insert(new Card(R.drawable.img199,"CB05-X02", "Jesmon", "Collaboration Booster (Our Digimon Adventure!", 0, "X RARE"));
            cardDao.insert(new Card(R.drawable.img200,"CB05-X02", "Jesmon AA", "Collaboration Booster (Our Digimon Adventure!", 0, "SECRET"));
            cardDao.insert(new Card(R.drawable.img201,"CB05-X03", "Magnamon", "Collaboration Booster (Our Digimon Adventure!", 0, "X RARE"));
            cardDao.insert(new Card(R.drawable.img202,"CB05-X03", "Magnamon AA", "Collaboration Booster (Our Digimon Adventure!", 0, "SECRET"));
            cardDao.insert(new Card(R.drawable.img203,"CB05-X04", "Paildramon", "Collaboration Booster (Our Digimon Adventure!", 0, "X RARE"));
            cardDao.insert(new Card(R.drawable.img204,"CB05-X04", "Paildramon AA", "Collaboration Booster (Our Digimon Adventure!", 0, "SECRET"));
            ...
            cardDao.insert(new Card(R.drawable.img206,"CB05-X05", "Imperialdramon FM AA", "Collaboration Booster (Our Digimon Adventure!", 0, "SECRET"));
            cardDao.insert(new Card(R.drawable.img207,"CB05-X06", "Alphamon", "Collaboration Booster (Our Digimon Adventure!", 0, "X RARE"));
            cardDao.insert(new Card(R.drawable.img208,"CB05-X06", "Alphamon AA", "Collaboration Booster (Our Digimon Adventure!", 0, "SECRET"));
